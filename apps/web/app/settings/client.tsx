    ...
    <div className="min-h-screen">
      ...
      <div className="p-4 md:p-6 grid grid-cols-1 xl:grid-cols-3 gap-4 max-w-6xl">
        ...
        <Card>
          ...
          <a
            href="/settings/invite-policy"
            className="flex items-center justify-between gap-3 px-4 py-3 border-t border-[var(--color-border)] hover:bg-[var(--color-border)]/30 transition-colors group"
          >
            <div className="min-w-0">
              <div className="text-[13px]">Invitation email domain policy</div>
              <div className="text-[11px] text-[var(--color-muted)] mt-0.5">
          ...
          >
            <div className="min-w-0">
              <div className="text-[13px]">Record of processing activities</div>
              <div className="text-[11px] text-[var(--color-muted)] mt-0.5">
                GDPR Article 30 register. Per-tenant catalogue of processing activities with lawful basis, retention, recipients, and CSV export.
              </div>
            </div>
            <CaretRight
              size={14}
          ...
          <a
            href="/settings/risk-register"
            className="flex items-center justify-between gap-3 px-4 py-3 border-t border-[var(--color-border)] hover:bg-[var(--color-border)]/30 transition-colors group"
          >
            <div className="min-w-0">
              <div className="text-[13px]">Enterprise risk register</div>
              <div className="text-[11px] text-[var(--color-muted)] mt-0.5">
                ISO 31000 and SOC 2 CC3.2 evidence. Per-tenant forward-looking risk catalogue with inherent and residual scoring, treatment, owner, review-due tracking, and CSV export.
              </div>
            </div>
            <CaretRight
              size={14}
          ...
          >
            <div className="min-w-0">
              <div className="text-[13px]">Data protection impact assessments</div>
              <div className="text-[11px] text-[var(--color-muted)] mt-0.5">
                GDPR Article 35 register. Per-tenant DPIA catalogue with necessity, risks, mitigations, residual risk, review-due tracking, and CSV export.
              </div>
            </div>
            <CaretRight
              size={14}
          ...
          <a
            href="/settings/vendor-risk"
            className="flex items-center justify-between gap-3 px-4 py-3 border-t border-[var(--color-border)] hover:bg-[var(--color-border)]/30 transition-colors group"
          >
            <div className="min-w-0">
              <div className="text-[13px]">Vendor risk register</div>
              <div className="text-[11px] text-[var(--color-muted)] mt-0.5">
                Per-workspace vendor risk assessments. Track sub-processors, integrations, and internal tools with inherent and residual risk, attested certifications, owner, status, review cadence, and CSV export.
              </div>
            </div>
            <CaretRight
              size={14}
          ...
          >
            <div className="min-w-0">
              <div className="text-[13px]">Business continuity and disaster recovery</div>
              <div className="text-[11px] text-[var(--color-muted)] mt-0.5">
                Per-service RTO and RPO declarations with DR strategy, runbook, last-tested date and outcome, overdue-test tracking, CSV export, and audit-logged mutations.
              </div>
            </div>
            <CaretRight
              size={14}
          ...
          >
            <div className="min-w-0">
              <div className="text-[13px]">Customer-managed encryption key</div>
              <div className="text-[11px] text-[var(--color-muted)] mt-0.5">
                Declare a BYOK / CMEK reference for this workspace, set a rotation cadence, and log every rotation.
              </div>
            </div>
            <CaretRight
              size={14}
          ...
          >
            <div className="min-w-0">
              <div className="text-[13px]">Vendor support access</div>
              <div className="text-[11px] text-[var(--color-muted)] mt-0.5">
                Lock the workspace so adherence.ml support cannot reach your tenant without a time-bound grant.
              </div>
            </div>
            <CaretRight
              size={14}
          ...
          >
            <div className="min-w-0">
              <div className="text-[13px]">Data subject access requests</div>
              <div className="text-[11px] text-[var(--color-muted)] mt-0.5">
                GDPR Art. 15-22 and CCPA / CPRA register with the 30 day response countdown.
              </div>
            </div>
            <CaretRight
              size={14}
